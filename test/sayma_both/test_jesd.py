...
# configure ad9514_0
ad9154_0 = AD9154(wb_rtm.regs, 0)
print("AD9154_0 configuration")
print("AD9154_0 present: {:s}".format(str(ad9154_0.check_presence())))
ad9154_0.reset()
ad9154_0.startup(jesd_settings, linerate=10e9, physical_lanes=0xff)
# show ad9514_1 status
ad9154_0.print_status()
